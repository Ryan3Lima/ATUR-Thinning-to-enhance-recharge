...
\hypersetup{
  ...
  pdfkeywords={Suitability mapping - Forest thinning - Water Resources -
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Study Area Map.jpg}}
...
30\% are required to see increases in water yield. To remove 30\% of the
basal area and have thinned forests remain within the historical range
of pre-settlement forest density all cells with basal areas of 13.14
\(m^2 ha^-1\) or less were given a value of 1, suitability then
increases in a linear fashion til it reaches 10 at a basal areas
\textgreater= 25.71 \(m^2 ha^-1\) resulting in the scaled basal area
thematic layer (sBA)
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/fig-veg-1.pdf}}
...
a linear weights of 0.6667 and 0.3333 respectively to create the
vegetation density index (VDI) shown in Equation~\ref{eq-vdi}. This
reflects the fact that reductions in basal area are more likely
correlated with reductions in ET, while canopy cover primarily affects
precipitaiton partioning and sub-canopy solar radiation.
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Soilsmap.jpg}}
...
extracted and the polygons were rasterized at a 30m resolution, then
re-scaled to values (1-10) as shown in \textbf{?@tbl-glhymps} .
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Geology_2_perm_porosity.jpg}}
...
lineaments (roads, railways, and power lines) were not largely
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Geology_karst_lineaments.jpg}}

}

\caption{\label{fig-linpk}Lineaments (left) are indicative of
fracturing, higher secondary permeability and porosity. Presence or
Absence of karst or Pseudo-karst (Right)}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Statewide_suitability_Ponderosa_Pine.jpg}}
