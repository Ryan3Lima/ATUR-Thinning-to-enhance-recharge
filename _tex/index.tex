...
\caption{This is a map showing the extent of our study area and the
distribution of Ponderosa pine-dominant forests. The Colorado Plateau
physiographic province is shown in light grey, while areas within our
study area at elevations above 2000m are shown in dark grey. The HUC8
watersheds are shown in black, and the boundary of Arizona is shown in
Red.}
...
Thinned forests also tend to have more snow and soil moisture
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/Geology_2_perm_porosity.jpg}}

}

\caption{Permeability and Porosity of the Lithology}

\end{figure}%%
\begin{figure}[H]

{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/Geology_karst_lineaments.jpg}}

}

\caption{Lineaments (left) are indicative of fracturing, higher
...
6.48. The remainder of the ponderosa pine forest is moderate
suitability, low suitability, or not suitable for thinning to enhance
recharge 41.28\% (761,781 hectares). Only about 3\% of the ponderosa
pine forest classified as very high and high suitability fall within
wilderness boundaries.

\begin{figure}[H]

{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/Statewide_suitability_Ponderosa_Pine.jpg}}
