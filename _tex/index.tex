...
Our study area (AZHU8) includes all of the HUC8s of Arizona, extending
into 5 other states but excluding Mexico. Ponderosa Pine woodlands cover
1.8 million hectares (1,835,530.65) of our Study area or around 30\%
(28.38\%) of the forested area within AZHU8. Most of that forest is
along the top of the Mogollon Rim, with smaller isolated patches on
mountain ranges and plateaus such as the Chuska Mountains, the Zuni
Mountains, the Kaibab plateau and the Defiance plateau. The Mogollon Rim
is a topographic feature forming the southern edge of the Colorado
Plateau. It has been identified as an essential groundwater recharge
area for regional aquifers \citep{parker2005} of the estimated 2.1
billion \(m^3\) (174,000 acre-feet of precipitation that falls on the
Mogollon Rim, about 8\% is estimated to recharge the regional
groundwater aquifers\citep{parker2005}. Precipitation along the Mogollon
Rim is bi-modal, with wet winters and a late-summer monsoon season.
Ponderosa Pine are primarily found at elevations between 2000 and 2400m.

\begin{figure}[H]

{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/Study Area Map.jpg}}

}

\caption{Map showing the Extent of the AZHU8 study area and the
...
Estimates of pre-settlement ponderosa pine forest basal area were 11.5
\(m^2\)/ha or 50 \(ft^2\)/acre. Since basal area reductions of at least
30\% are required to see increases in water yield. In order to remove
30\% canopy cover and have forests with over 11.5 \(m^2\)/ha the
